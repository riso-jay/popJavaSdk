 ...
 * 获取订单头响应
 */
public class GetBigOrderHeaderRespone implements java.io.Serializable{
    ...
    /**
     * 订单状态：3：下单中；4：下单失败；100：已下单；200：拣货中；300：已拣货；400：已出仓；500：已签收；600：已拒收
     */
    ...
    private String wopOdsOrderSn;

    // 构造函数
    public GetBigOrderHeaderRespone() {super();}
    ...
    public String getWopOdsOrderSn() {
        return wopOdsOrderSn;
    }

    public void setWopOdsOrderSn(String wopOdsOrderSn) {
        this.wopOdsOrderSn = wopOdsOrderSn;
    }
