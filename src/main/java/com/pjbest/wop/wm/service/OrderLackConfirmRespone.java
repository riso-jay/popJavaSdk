 ...
 * 订单缺货拉取确认响应
 */
public class OrderLackConfirmRespone implements java.io.Serializable{
    ...
    /**
     * 结果子编码 200：成功,201:被忽略的重复操作,500：失败
     */
    @Required("结果子编码 200：成功,201:被忽略的重复操作,500：失败 ")
    ...
    // 构造函数
    public OrderLackConfirmRespone() {super();}
