 ...
 * 提交大订单响应
 */
public class SubmitBigOrderRespone implements java.io.Serializable{
    ...
    /**
     * 结果子编码：200：成功，201：订单已提交过，500：失败
     */
    @Required("结果子编码：200：成功，201：订单已提交过，500：失败 ")
    ...
    // 构造函数
    public SubmitBigOrderRespone() {super();}
