 ...
 * 创建退供单信息
 */
public class CreateInvReturnOrderReq implements java.io.Serializable{
     ...
     */
    @Required("退供类型：110正常退供，111残次退供，112过期退供，113入库凭证退供 ")
    ...
    // 构造函数
    public CreateInvReturnOrderReq() {super();}
